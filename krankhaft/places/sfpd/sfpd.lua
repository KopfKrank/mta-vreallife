...
SFPDExitOptic = createMarker ( 246.40328979492, 107.60005950928, 1002.1927490234, "corona", 1, getColorFromString ( "#FF000099" ) )
setElementInterior (SFPDExit, 10)
setElementInterior (SFPDExitOptic, 10)

createMarker ( -1605.423828125, 710.54425048828, 12.792203903198, "corona", 1, getColorFromString ( "#FF000099" ) )
SFPDEnter = createMarker ( -1605.423828125, 710.54425048828, 12.792203903198+0.5, "corona", 1, 0, 0, 0, 0 )

SFPDLiftInner = createMarker ( 214.28958129883, 120.01245880127, 1002.1906738281, "corona", 1, getColorFromString ( "#FF000099" ) )
...
SFPDLiftOuter = createMarker ( -1606.3905029297, 672.76336669922, -6.2766346931458, "corona", 1, getColorFromString ( "#FF000099" ) )
...
LVPDLiftInOptic = createMarker ( 2277.6525878906, 2458.3308105469, 37.624977111816, "corona", 1, getColorFromString ( "#FF000099" ) )
LVPDLiftOutOptic = createMarker ( 251.55657958984, 196.95166015625, 1007.099609375, "corona", 1, getColorFromString ( "#FF000099" ) )
...
--[[
pdEnter" type="corona" color="#FF000099" size="1" interior="0, , -1605.423828125, 710.54425048828, 12.792203903198
pdOutSpawn" doublesided="false" model="1337" interior="0, , -1605.4925537109, 711.98028564453, 13.516412734985
sfPDExit" type="corona" color="#0000ff99" size="1" interior="10, , 246.40328979492, 107.60005950928, 1002.1927490234
