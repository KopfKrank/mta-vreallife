...
function refreshLicenses()
	...
	elseif getElementData ( player, "playingtime" ) >= 60 * 25 then
		...
		guiGridListSetItemText( gGrid["Licenses"], row, gColumn["cityhallPreis"], "1200 $", false, false )
	end
	...
	guiGridListSetItemText( gGrid["Licenses"], row, gColumn["cityhallPreis"], "1000 $", false, false )
	...
	guiGridListSetItemText( gGrid["Licenses"], row, gColumn["cityhallPreis"], "850 $", false, false )
