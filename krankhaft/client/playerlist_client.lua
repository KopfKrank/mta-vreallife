...
function showPlayerList ()
	...
	if gImage["playerList"] then
		...
		label = guiCreateLabel(40,39,51,23,"",false,gImage["playerList"])
		guiSetAlpha(label,1)
		...
		--guiSetAlpha(img,0.7)
		label = guiCreateLabel(166,39,88,23,"",false,gImage["playerList"])
		guiSetAlpha(label,1)
		guiLabelSetColor(label,255,255,255)
		guiLabelSetVerticalAlign(label,"top")
		guiLabelSetHorizontalAlign(label,"left",false)
		guiSetFont(label,"default-bold-small")
		label = guiCreateLabel(290,39,52,20,"",false,gImage["playerList"])
		guiSetAlpha(label,1)
		guiLabelSetColor(label,255,255,255)
		guiLabelSetVerticalAlign(label,"top")
		guiLabelSetHorizontalAlign(label,"left",false)
		...
		--guiSetAlpha(img,0.7)
		label = guiCreateLabel(360,39,62,16,"",false,gImage["playerList"])
		guiSetAlpha(label,1)
		guiLabelSetColor(label,255,255,255)
		guiLabelSetVerticalAlign(label,"top")
		guiLabelSetHorizontalAlign(label,"left",false)
		...
		label = guiCreateLabel(443,39,65,15,"",false,gImage["playerList"])
		guiSetAlpha(label,1)
		guiLabelSetColor(label,255,255,255)
		guiLabelSetVerticalAlign(label,"top")
		guiLabelSetHorizontalAlign(label,"left",false)
		...
		label = guiCreateLabel(546,39,57,15,"",false,gImage["playerList"])
		guiSetAlpha(label,1)
		guiLabelSetColor(label,255,255,255)
		guiLabelSetVerticalAlign(label,"top")
		guiLabelSetHorizontalAlign(label,"left",false)
