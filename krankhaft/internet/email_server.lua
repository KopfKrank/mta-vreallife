...
function sendMail_func ( text, betreff, to )
	...
	if exists then
		local mail = tostring ( getPlayerName(client).."@Krankhaft-Reallife.de|"..betreff.."|"..timestamp()..": "..text )
		...
		outputChatBox ( "Ungueltige Eingabe, bitte verwende folgende Eingabe: [Name@Krankhaft-Reallife.de]", client, 125, 0, 0 )
	end
end
