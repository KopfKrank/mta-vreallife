...
function showTutUltimate ( )
	dxDrawText ( "Krankhaft Reallife", 0, 0, screenX, screenY, tocolor ( 25, 96, 178 ), 8, "pricedown", "center", "center", false, true, true )
end
