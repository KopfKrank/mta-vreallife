	...
	if player == client then
		local pname = getPlayerName ( player )
			if vioGetElementData ( player, "loggedin" ) == 0 and not isRegistered ( pname ) and player == client then
				...
				vioSetElementData ( player, "money", 3500 )
				...
				vioSetElementData ( player, "bankmoney", 1500 )
				...
				vioSetElementData ( player, "socialState", "Spieler" )
				...
				if pwresult == hash ( "sha512", passwort ) then	
					...
					if result then
						if result[1] then
							...
							outputChatBox ( "╔ Willkommen auf Krankhaft-Reallife ", player, 255, 0, 0 )
							outputChatBox ( "╠ Bei Fragen /support benutzen ", player, 255, 0, 0 )
							outputChatBox ( "╠ Teamspeak: 1.ts-3.net:10139", player, 255, 0, 0 )
							outputChatBox ( "╠ Script wird weiterentwickelt.", player, 255, 0, 0 )
							outputChatBox ( "╚ Ende!", player, 255, 0, 0 )
