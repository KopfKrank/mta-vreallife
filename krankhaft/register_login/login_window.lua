...
local function mainRender()
	...
	elseif ( state == 'animation' ) then
		...
		elseif ( phase == 2 ) then
			...
			dxDrawText('Anmelden', posX, resY/2-55, left, top, tocolor(255,255,0,alpha), 1, segoeui, 'left', 'center') 
			...
			dxDrawText ( "Krankhaft-Reallife", resX-375, resY-100, 375, screenheight, tocolor ( 255, 255, 0 ), 2, "pricedown", "left", "top" )
			if ( lastTick+1500 <= getTickCount() ) then
				setSettings( 'ready', 0 )
			end
		end
	elseif ( state == 'ready' ) then
		dxDrawText('Anmelden', resX/2-20, resY/2-55, left, top, tocolor(255,255,0,255), 1, segoeui, 'left', 'center') 
	...
	elseif ( state == 'finished' ) then
		...
		dxDrawText('Krankhaft-Reallife', posX+220, resY/2-55, left, top, tocolor(255,255,0,255), 1, segoeui, 'left', 'center') 
		...
		dxDrawText ( "Krankhaft-RL", resX-375, resY-100, 375, screenheight, tocolor ( 255, 255, 0 ), 2, "pricedown", "left", "top" )
		if #password > 0 then
